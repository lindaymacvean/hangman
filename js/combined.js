		...
		try {
			window.Ehangman = function() {
				...
				function setup() { //written as a method which can be reused
					...
					$('.lettres span').removeClass();
					$('.lettres span').unbind('click'); //once event captured unbind the click event
			...
			}(); //self invoke Ehangman and return setup & processLettre as a method
